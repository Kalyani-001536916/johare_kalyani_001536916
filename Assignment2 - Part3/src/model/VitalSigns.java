...
public class VitalSigns {
    ...
    public String toString() {
        return "VitalSigns{" + "ageGroup=" + ageGroup + ", respiratoryRate=" + respiratoryRate + ", heartRate=" + heartRate + ", systolicBloodPressure=" + systolicBloodPressure + ", weightKg=" + weightKg + ", weightPounds=" + weightPounds + ", timeStamp=" + timeStamp + '}';
    }
